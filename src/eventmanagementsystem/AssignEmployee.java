...
public class AssignEmployee extends javax.swing.JFrame {
    String o_id,o_date,o_time,category,query;
    /**
     * Creates new form AssignEmployee
     */
    public AssignEmployee(String order_ID) {
        initComponents();
        this.o_id=order_ID;
        oid.setText(o_id);
        fetchDetails();
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(oid)
                            .addComponent(ttf)
                            .addComponent(cc, 0, 150, Short.MAX_VALUE))
    ...
    private void etMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_etMouseClicked
        ...
        try{
            String q="insert into assignedEmployee (Order_ID,Emp_ID,OrderDate,OrderTime) values (?,?,?,?)";
            PreparedStatement pst=co.connection.prepareStatement(q);
            pst.setInt(1,Integer.parseInt(o_id));
            pst.setInt(2,Integer.parseInt(eid));
            pst.setString(3,o_date);
            pst.setString(4,o_time);
            pst.executeUpdate();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        co.connectDB();
        try{
            query="insert into ConfirmedOrders select O_Date,O_Time,Event_address,Res_Name,Res_ID,Order_ID,C_ID,TotalAmount from Orders where Order_ID = "+o_id;
   ...
   public ArrayList<Employee> employeeList(){
        ...
        try {
            ...
            query="Select * FROM Employees where Emp_ID in (select Emp_ID from Employees Except (select E.Emp_ID from Employees E inner join assignedEmployee  A on E.Emp_ID = A.Emp_ID where A.OrderDate = '"+o_date+"' and A.OrderTime = '"+o_time+"')) and category = '"+category+"'";
    ...
    void fetchDetails(){
        ...
        try {
            ...
            query="SELECT * FROM Orders where Order_ID = "+o_id;
           
            co.resultSet = co.statement.executeQuery(query);
           

            while (co.resultSet.next()) {
               o_date=co.resultSet.getString("O_Date");
               o_time=co.resultSet.getString("O_Time");
               dtf.setText(o_date);
               ttf.setText(o_time);
