...
public class OutdoorEventOrders extends javax.swing.JFrame {
   ...
   String cid,etype;
     ...
     */
    public OutdoorEventOrders(String cID,String type) {
        initComponents();
        this.cid=cID;
        this.etype=type;
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(nl_c, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(nl_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(15, 15, 15)
                .addComponent(jLabel4)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(c_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(15, 15, 15)
                .addComponent(jLabel5)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cost_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(15, 15, 15)
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel8))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(time_c, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jButton1)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void formatQuery()
    {
        ...
        if(initDate.equals("December 31,7000")){
         ...
         generalQuery= "Select *from Restaurant where NOT EXISTS (Select R.Res_ID,O.Res_ID from Restaurant as R inner join ConfirmedOrders as O on (R.Res_ID = O.Res_ID) where O.O_Time = '"+z+"' and O.O_Date = '"+initDate+"' and R.Res_Name like '"+y+"') and "
           +x+" like '"+y+"' and Capacity >= "+initCapacity+" and Booking_Cost <= "+ initCost;
        
        else if(!(initDate.equals("December 31,7000"))&& flag==1){        
          generalQuery= "Select *from Restaurant where EXISTS (Select R.Res_ID,O.Res_ID from Restaurant as R inner join ConfirmedOrders as O on (R.Res_ID = O.Res_ID) where O.O_Time = '"+z+"' and O.O_Date = '"+initDate+"' and R.Res_Name like '"+y+"') and "
           +x+" like '"+y+"' and Capacity >= "+initCapacity+" and Booking_Cost <= "+ initCost;        
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OutdoorEventOrders.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OutdoorEventOrders("1","1").setVisible(true);
