...
public class TopCustomersAndRestaurants extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(oc, 0, 160, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       if(option.equals("Restaurant"))
           query="select R.Res_ID as ID,Sum(O.TotalAmount) as TotalAmount from Restaurant R inner join ConfirmedOrders O on R.Res_ID= O.Res_ID group by R.Res_ID order by Sum(O.TotalAmount) desc";
       else 
           query="select C.C_ID as ID ,Sum(O.TotalAmount) as TotalAmount from Customer C inner join ConfirmedOrders O on C.C_ID= O.C_ID group by C.C_ID order by Sum(O.TotalAmount) desc";
       getOrders();
    ...
    public ArrayList<ConfirmedOrders> PrOList(){
        ...
        try {
            ...
            while (co.resultSet.next()) {
                CO=new ConfirmedOrders(" "," "," "," ",0,co.resultSet.getInt("ID"),0,0,co.resultSet.getInt("TotalAmount"));
